...
with st.form(
    ...
    good_thing = st.text_input(
        "今日、何がよかった？",
        value=default_good_thing,
        placeholder=(
            "例：朝に少し勉強できた"
        ),
    )
...
if past_records:
    ...
    with st.container(
        ...
        st.markdown(
            f"### 🌟 "
            f"{random_record.get('good_thing', '')}"
        )
